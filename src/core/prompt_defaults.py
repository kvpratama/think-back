"""Hardcoded fallback prompt templates for ThinkBack.

These serve as defaults when LangSmith Hub is unavailable and as the
source of truth for ``scripts/push_prompts.py``.
"""

from langchain_core.prompts import ChatPromptTemplate

DEFAULTS: dict[str, ChatPromptTemplate] = {
